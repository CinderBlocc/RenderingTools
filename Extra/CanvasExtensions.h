...
namespace RT
{
	...
	void SetColor(CanvasWrapper canvas, std::string colorName, float opacity=255);
	void DrawDebugStrings(CanvasWrapper canvas, const std::vector<DebugString>& drawStrings, EDebugStringBackground background=EDebugStringBackground::BG_None, int minWidth=200);
}
